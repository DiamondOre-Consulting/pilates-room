...
export const buyMembership = asyncHandler(async (req, res) => {
    ...
    if (payment.status === 'captured') {
        ...
        if (!existingUser.isDiscovery) {
            ...
            await sendMail("jadonyash755@gmail.com", `Order Received From ${existingUser.firstName} For membership`, emailTemplateForAdmin(existingUser.firstName, existingUser.lastName, existingUser.email, membershipPackage.packageName))
