...
import {
  getClasses,
  getScheduledClass,
} from "../controllers/class.admin.controller.js";
...
import {
  fetchMoreInfoParamsSchema,
  getAllTrainingsQuerySchema,
  getSingleTrainingParamsSchema,
} from "../validator/training.validator.js";
import {
  buyMembershipBodySchema,
  getAllMembershipPackagesForUserQuerySchema,
} from "../validator/membershipPackage.validator.js";
...
userRouter.post(
  ...
  userMiddleware,
  validate({ params: newPasswordParamsSchema }),
  changePassword
);

userRouter.get(
  "/get-classes",
  validate({ query: getClassesQuerySchema }),
  getClasses
);
...
userRouter.get(
  "/get-single-training/:trainingId",
  validate({
...
userRouter.post(
  "/buy-membership/:membershipPackageId/:paymentId",
  userMiddleware,
  validate({
