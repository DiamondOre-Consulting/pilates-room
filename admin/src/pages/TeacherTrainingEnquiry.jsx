...
const TeacherTrainingEnquiry = () => {
  ...
  const handleGetAllContactEnquiry = async () => {
    ...
    const response = await dispatch(
      getEnquries({ page, limit, topic: "teacherTraining" })
    );
    ...
    <HomeLayout>
      <div>
        <div className="flex flex-col md:flex-row justify-between py-2">
          ...
          <div className="flex space-x-2 md:mt-0 mt-4 items-center text-sm">
...
export default TeacherTrainingEnquiry;
