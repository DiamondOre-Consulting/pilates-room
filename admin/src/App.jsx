...
const TeacherTrainingEnquiry = lazy(() =>
  import("./pages/TeacherTrainingEnquiry")
);
const PrivateClassesEnquiry = lazy(() =>
  import("./pages/PrivateClassesEnquiry")
);
    ...
    >
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          ...
          <Route
            path="/teacher-training-enquiries"
            element={<TeacherTrainingEnquiry />}
          />
          <Route
            path="/private-class-enquiries"
            element={<PrivateClassesEnquiry />}
          />
        </Route>
