			...
			<div className="container px-4">
				<div className="flex flex-col md:flex-row gap-10  justify-end items-center  max-w-7xl mx-auto">
					<div className="text-start flex flex-col justify-center items-center   ">
						<h2 className="  w-full text-4xl md:text-[5rem] leading-wide md:leading-tight ">
                        WELCOME TO 
						</h2>
                        <h2 className=" w-full text-4xl md:-mt-4  md:text-[5rem] leading-wide md:leading-tight ">
                       EXHALE 
						</h2>
                        <h2 className=" w-full text-4xl md:-mt-4  md:text-[5rem] leading-wide md:leading-tight ">
                     PILATES
					...
					<div className="md:w-1/2 mt-5 space-y-6 lg:pr-4">
						<p className="text-base tracking-widest opacity-80 ">
                        Exhale is one of the UK’s most well known and loved Pilates brands. Dedicated in teaching Classical Pilates, the true works of Joseph Pilates called Contrology.
						</p>
						<p className="text-base tracking-widest opacity-80 ">
