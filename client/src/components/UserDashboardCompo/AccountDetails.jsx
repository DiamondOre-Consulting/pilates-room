...
const AccountDetails = () => {
  ...
  return (
    <div>
      ...
      <form className=" flex flex-col justify-start itmes-start">
        ...
        {showNewPasswordFeild && (
          <div className="border-gray-400 border-b flex  flex-col justify-start text-left text-[16px] py-2">
            ...
            <div className="flex  justify-between">
              ...
              <button  className="bg-dark px-2 py-1 text-white ml-3 cursor-pointer " onClick={handleChangePassword}>            {loader ? (
                            <div
                              role="status"
                            ...
                            >
                              <svg
                                aria-hidden="true"
                                className="inline w-3 h-3 text-gray-200 animate-spin fill-gray-600"
                                viewBox="0 0 100 101"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                              >
