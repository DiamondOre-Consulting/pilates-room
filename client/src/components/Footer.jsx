...
const Footer = () => {
  return (
    <div>
      ...
      <section class="py-10 bg-dark text-white sm:pt-16 lg:pt-4">
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12">
            <div class="lg:col-span-4 text-white">
              <ul class="mt-6 ">
                <Link to={"/"}>
                  <a
                    title=""
                    class="flex text-sm mb-4 text-gray-100 uppercase transition-all duration-200 hover:text-color1 focus:text-orange-600"
                  >
                    Contact Us
                  </a>
                </Link>
                ...
                <Link to={"/"}>
                  <a
                    title=""
                    class="flex text-sm text-gray-100 uppercase transition-all duration-200 hover:text-color1 focus:text-orange-600"
                  >
                    Privacy ploicy
                  </a>
                </Link>
            ...
            <div class="lg:col-span-4 text-white">
              <ul class="mt-6  flex flex-col justify-center  text-center items-center ">
                <Link to={"/"}>
                  <a
                    title=""
                    class="flex text-sm mb-4 text-gray-100 uppercase transition-all duration-200 hover:text-color1 focus:text-orange-600"
