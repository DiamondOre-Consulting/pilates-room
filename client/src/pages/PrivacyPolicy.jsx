      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          <p>
            ...
            Platform (referred to as “Learners”, “You”, “Your”).
          </p>
          ...
          <p>
            ...
            Privacy Policy can be found in our Terms of Use. Please read this
          ...
          <h3 className="font-bold">Personal Identifiable Information:</h3>
          <p>
          ...
          <ul>
            ...
            <li>
              To improve our Platform and maintain safety: We use Your
              ...
              applicable, our legitimate interests in the proper administration
              of our Platform, and/or the performance of a contract between You
              and us.
            </li>
            <li>
              To communicate with You or market our services/products: We may
          ...
          <p>
            Limit the information You provide: You always have an option to
          ...
          <p>
            Limit the communications You receive from us: Further, You will also
            have the option to choose what kind of communication You would like
            to receive from us. However, there may be certain communications
            that are required for legal or security purposes, including changes
            to various legal agreements, that you may not be able to limit.
          </p>
          <p>
            Reject Cookies and other similar technologies: You may reject or
          ...
          <p>
            ...
            you can always write to us at the address noted in the ‘Grievances’
            section below, and we will address your concerns to the extent
          ...
          <p>
            ...
            in the ‘Grievances’ section below, then, as per the applicable Data
            Protection Laws, we may need to ask you a few additional information
            to verify your identity in association with the Platform and the
            request received.
          </p>

          <h2 className="font-bold">PROTECTION OF YOUR INFORMATION:</h2>
          <p>
          ...
          <ul>
            <li>
              our employees, contractors and affiliated organizations (if any)
              that (i) need to know that information in order to process it on
              our behalf or to provide services/products to you and (ii) are
              subject to strict contractual confidentiality obligations and/or
              professional duties; and
            </li>
            <li>
              other parties to the extent necessary to comply with the
              applicable laws and regulations, and requests by public and
              government authorities, including to meet national security or law
          ...
          <p>
            ...
            that we do not endorse and are not responsible for the privacy
            practices or content of any such third party websites. We encourage
            Users to be aware when they leave our Platform and to read the
            privacy statements of each and every website that collects Personal
            Information.
          </p>

          <h2 className="font-bold">CROSS-BORDER DATA TRANSFER:</h2>
          <p>
            ...
            protection laws may differ from those of your jurisdiction. By using
            the Platform, You consent to such transfer.
          </p>
        </div>
